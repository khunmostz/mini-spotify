    ...
    <React.Fragment>
      <div className="flex flex-col">
        <div className="flex flex-col  text-gray-400 ">
          ...
          <div className="flex justify-start items-center text-bold text-lg mt-2 hover:text-white">
            <div className="ml-5 mr-3 text-2xl">
              <AiFillHome />
            </div>
            <span className="text-sm">Home</span>
          </div>
          <div className="flex justify-start items-center text-bold text-lg pt-4 hover:text-white">
            <div className="ml-5 mr-3 text-2xl">
              <FiSearch />
            </div>
          ...
          <div className="flex justify-start items-center text-bold text-lg mt-8 hover:text-white">
            <div className="ml-5 mr-3 text-2xl">
              <GoDiffAdded />
            </div>
        ...
        <div className="flex flex-col justify-start items-start text-bold text-lg pt-4 text-gray-400  pb-3">
          <div className="ml-5 mr-3 text-xs hover:text-white">Cookies</div>
          <span className="ml-5 mr-3 mt-3 text-xs hover:text-white">
            Privacy
          </span>
        </div>
      </div>
