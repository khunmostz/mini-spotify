                    ...
                    {result.list.map((value, index) => {
                      ...
                      return (
                        <tr key={index} className=" text-gray-400">
                          <td className="pt-4 pr-4 mb-2">{value.id}</td>
                          <td className="pt-4 flex mb-2">
                            <div>
                              {" "}
                              <Image
                                src={value.image}
                          ...
                          <td className="pt-4 mb-2">{value.album}</td>
                          <td className="pt-4 mb-2">{value.datetime}</td>
                          <td className="pt-4 mb-2">{value.time}</td>
                        </tr>
                      );
                    })}
                  </>
