                            ...
                            return <>
                                ...
                                {result.list.map((value, index) => {
                                    return <tr key={index} className=' text-gray-400'>
                                        <td className='pt-4 pr-4'>{value.id}</td>
                                        ...
                                        <td className='pt-4'>{value.album}</td>
                                        <td className='pt-4'>{Date.now().toLocaleString().toString()}</td>
                                        <td className='pt-4'>{value.time}</td>
                                    </tr>
                                })}
