...
function OnCard() {
  ...
  return (
    <React.Fragment>
      <div className="flex flex-col w-full xl:h-[93.0vh] lg:h-[90vh] md:h-[93.1vh] sm:h-[92.5vh] overflow-auto ">
        <header className="w-full h-96 bg-gradient-to-b from-green-500 via-green-600 to-green-800 flex justify-start items-center">
          <div className="p-5">
            {spotify
              .filter((filter) => filter.title === slug)
              .map((value, index) => {
                return (
                  <Image
                    key={index}
          ...
          <div className="text-white">
            ...
            <div className="mt-6">
              ...
              <div>Spotify ● ถูกใจ 245,678 ครั้ง ● เพลง, ประมาณ 7 ชม</div>
            </div>
          </div>
        </header>
